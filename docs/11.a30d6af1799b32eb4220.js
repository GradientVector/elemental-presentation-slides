...
var startTapClick = function (config) {
    ...
    var onMouseDown = function (ev) {
        var t = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev) - MOUSE_WAIT;
        if (lastTouch < t) {
            pointerDown(ev);
        }
    };
    ...
    var setActivatedElement = function (el, ev) {
        ...
        clearTimeout(activeDefer);
        activeDefer = undefined;
        var _a = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev), x = _a.x, y = _a.y;
        // deactivate selected
        if (activatableEle) {
...
//# sourceMappingURL=11.a30d6af1799b32eb4220.js.map